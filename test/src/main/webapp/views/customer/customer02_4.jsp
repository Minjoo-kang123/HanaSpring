...
<div class="communitySection2 container text-center">
  ...
  <div class="question">
    <table>
      <tr>
        <td>제목</td>
        <td><span class="inputStyle1">${data.qnaTitle}</span></td>
      </tr>
      <tr>
        <td>작성자</td>
        <td><span class="inputStyle1">${data.qnaName}</span></td>
      </tr>
      <tr>
        <td>작성일</td>
        <td><span class="inputStyle1"><fmt:formatDate pattern="yyyy-MM-dd" value="${data.qnaDate}"/></span></td>
      </tr>

      <tr>
        <td>내용</td>
        <td><span class="inputStyle1">${data.qnaContent}</span></td>
      </tr>
    </table>

    <div class="btn">
      <button onclick="location.href='<c:url value="/customer/customer02"/>'"> <img src="<c:url value="/img/customer/list.gif"/>"> </button>
    </div>
  </div>
</div>
<!-- 묻고답하기 - 글쓰기 -->
